...
const components = [
  ...
  },
  {
    ...
    description:
      "The inner drive to engage in work for its own sake is the most powerful lever managers can influence (Deci & Ryan, 2000; Amabile, 1998).Nobody ever did their best work because someone told them to. Think about the last time you lost track of time doing something. Not grinding through it, not checking the clock, just genuinely absorbed, following one idea into the next because you couldn't help yourself. That state isn't accidental. It's what happens when the work itself is the reward, and it's one of the most powerful forces in human creativity. Richard Feynman is one of the clearest examples of this. He was a Nobel Prize-winning physicist, but if you read his interviews or watch his lectures, what strikes you isn't his intelligence, it's his delight. He talked about physics the way a kid talks about a magic trick they just figured out. He pursued problems because not understanding something genuinely bothered him. The recognition came later. The curiosity came first, and it never really left. Deci and Ryan (2000) and Amabile (1998) both point to this as the core driver of creative output. When you're internally motivated, when you care about the work for its own sake, you naturally go deeper, stay longer, and take the kinds of risks that people chasing approval rarely take. External pressure can produce results, but it rarely produces breakthroughs. This matters for how you structure your life, not just your career. The environments you put yourself in, the projects you say yes to, the problems you choose to sit with, all of it shapes whether your creativity gets to breathe or slowly suffocates under obligation. You don't manufacture that kind of motivation. You protect it. You notice what genuinely pulls your attention and you follow it seriously, even before the world tells you it's worth following. That's where the real work be ins.",
